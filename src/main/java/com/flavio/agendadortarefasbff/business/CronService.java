...
public class CronService {
    ...
    public void buscaTarefasProximaHora() {
        ...
        LocalDateTime horaAtual = LocalDateTime.now(); //LocalDateTime.now(hora atual (se a hora atual for 17:00))
        LocalDateTime horaFutura = LocalDateTime.now().plusHours(1);
        //LocalDateTime.now.pusHours(1 hora para frente(vai trazer qualquer tarefa entre as 17:00 até as 18:00))
